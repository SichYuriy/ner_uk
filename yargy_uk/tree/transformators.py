...
from yargy_uk.pipelines import PipelineProduction
from yargy_uk.interpretation.interpretator import InterpretatorInput
...
class RelationsTransformator(InplaceTreeTransformator):
    def __init__(self):
        from yargy_uk.relations.graph import TokenRelationsGraph
...
class DotTreeTransformator(DotTransformator, InplaceTreeTransformator):
    def __init__(self):
        ...
        from yargy_uk.relations.graph import RelationsGraph
