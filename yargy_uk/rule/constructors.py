...
from yargy_uk.compat import string_type
from yargy_uk.utils import (
    Record,
    assert_type,
    assert_greater_equals
)
from yargy_uk.visitor import TransformatorsComposition
from yargy_uk.predicates import Predicate
from yargy_uk.relations import Main
...
class Rule(Record):
    ...
    def interpretation(self, item):
        from yargy_uk.interpretation import prepare_rule_interpretator
...
class InterpretationRule(WrapperRule):
    ...
    def __init__(self, rule, interpretator):
        from yargy_uk.interpretation import Interpretator
...
class RelationRule(WrapperRule):
    ...
    def __init__(self, rule, relation):
        from yargy_uk.relations import Relation
