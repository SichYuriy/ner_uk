...
from natasha_uk import OrganisationExtractor
from natasha_uk.grammars.organisation import Organisation
...
tests = [
    ...
    [
        'ЗАО "Сервисный центр "Энергия"',
        Organisation(name='ЗАО "Сервисный центр "Энергия"'),
    ],
]
